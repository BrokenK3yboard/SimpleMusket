...
public class ModEnchantments {
    ...
    public static int modifyAmmoCount(ItemStack stack, float ammoCount) {
        ...
        EnchantmentHelper.runIterationOnItem(stack, (enchantment, enchantmentLevel) -> enchantment.value().getEffects(ModRegistry.AMMO_COUNT).forEach(
                effect -> mutableFloat.setValue(effect.effect().process(enchantmentLevel, stack, ammoCount))));
