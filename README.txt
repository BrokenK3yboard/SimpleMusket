...
Iron: Basic bullet, deals 16 damage and ignores 50% of the target's armor.
Copper: Fires a wide spread of 5 pellets, each doing 4 damage.
Gold: Deals 9 damage, but increases if fired out of an enchanted musket. Damage bonus affected by the number and rarity of enchantments.
Netherite: Deals 18 damage and ignores 100% of the target's armor, but wears out the musket 3x faster. Small amounts can only be found in nether bastion chests by default.
